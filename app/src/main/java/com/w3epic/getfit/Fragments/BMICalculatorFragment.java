...
public class BMICalculatorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_bmicalculator, container, false);

        ((Button) rootView.findViewById(R.id.btnCalculateBmi)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                calculateBMI(rootView);
            }
        });
    ...
    private void displayBMI(float bmi, View view) {
        ...
        bmiLabel = bmi + "\n\n" + bmiLabel;
        TextView result = view.findViewById(R.id.resultBMI);
